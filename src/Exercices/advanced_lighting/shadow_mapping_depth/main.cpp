...
int main() {
    ...
    // -------------------------
    Shader simpleDepthShader("../src/shaders/simple_depth_shader.vs", "../src/shaders/simple_depth_shader.fs");
    Shader debugDepthQuad("../src/shaders/debug_quad_depth.vs", "../src/shaders/debug_quad_depth.fs");
