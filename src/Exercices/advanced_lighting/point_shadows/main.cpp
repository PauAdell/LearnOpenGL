...
int main() {
    ...
    // -------------------------
    Shader simpleDepthShader("../src/shaders/point_shadows_depth.vs", "../src/shaders/point_shadows_depth.fs", "../src/shaders/point_shadows_depth.gs");
    Shader shader("../src/shaders/point_shadows.vs", "../src/shaders/point_shadows.fs");
