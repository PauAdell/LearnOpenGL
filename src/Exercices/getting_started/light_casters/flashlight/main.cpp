...
int main() {
    ...
    Shader lightingShader("../src/shaders/materials.vert", "../src/shaders/materials.frag");
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        // light properties
        lightingShader.setVec3("light.ambient", 0.2f, 0.2f, 0.2f); // note that all light colors are set at full intensity
