...
int main() {
    ...
    Shader sourceShader("../src/shaders/shader.vert", "../src/shaders/lightSource.frag");
    Shader lightingShader("../src/shaders/shader.vert", "../src/shaders/lighting.frag");
    lightingShader.use();
...
// positions // normals // texture coords
    ...
    glm::mat4 view;
    //view = glm::rotate(view, glm::vec3(0.0f, (float)glfwGetTime() * glm::radians(1.0f), 0.0f));
