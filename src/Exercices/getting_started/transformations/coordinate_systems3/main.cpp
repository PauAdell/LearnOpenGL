...
int main() {
    ...
    // this is setting the texture manually
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        //glm::mat4 view = glm::mat4(1.0f);
        //view = glm::rotate(view, (float)glfwGetTime() * glm::radians(1.0f), glm::vec3(0.0f, 1.0f, 0.0f));
        //view = glm::translate(view, glm::vec3(0.0f, 0.0f, -2.5f));
        //view = glm::rotate(view, (float)glfwGetTime() * glm::radians(12.0f), glm::vec3(0.0f, 1.0f, 0.0f));
