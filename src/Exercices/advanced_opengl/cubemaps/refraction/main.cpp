...
int main() {
    ...
    Shader shader("../src/shaders/cubemap.vs", "../src/shaders/cubemap.fs");
    ...
    {   
        FileSystem::getPath("src/textures/skybox/right.jpg").c_str(),
        FileSystem::getPath("src/textures/skybox/left.jpg").c_str(),
        FileSystem::getPath("src/textures/skybox/top.jpg").c_str(),
        FileSystem::getPath("src/textures/skybox/bottom.jpg").c_str(),
        FileSystem::getPath("src/textures/skybox/front.jpg").c_str(),
        FileSystem::getPath("src/textures/skybox/back.jpg").c_str()
    };
