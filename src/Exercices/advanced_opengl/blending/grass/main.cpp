...
int main() {
    ...
    Shader shaderSingleColor("../src/shaders/depth_testing.vs", "../src/shaders/shaderSingleColor.fs");
    ...
    unsigned int grassTexture = loadTexture(FileSystem::getPath("src/textures/grass.png").c_str());
